  ...
  return (
    <Modal className="pt-6 space-y-8" onClose={onClose}>
      ...
      <div className="space-y-4">
        <div className="rounded-[20px] bg-border p-4 space-y-3">
          <div className="pb-3 space-y-2">
            {/* Amount */}
            <p className="text-base font-normal leading-6 text-text text-center">Amount to Fund</p>
            <p className="text-2xl font-semibold leading-8 text-card-text text-center">₦{amount}</p>
          </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={row.label} className="flex items-center justify-between text-xs">
                <span className="font-medium text-xs leading-5 text-text">{row.label}</span>
                {row.isAccount ? (
        ...
        <div className="flex items-center gap-4 text-xs text-text">
          ...
          <span className="font-normal leading-4.6">Funds will be debited directly from your selected bank account.</span>
        </div>
      </div>
      ...
      <div className="flex gap-4">
        ...
        <Button size="lg" className="flex-3" onClick={onConfirm}>Confirm Funding</Button>
      </div>
    </Modal>
  );
}