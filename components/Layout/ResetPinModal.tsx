...
import { ResetPinForm, resetPinSchema, UpdatePinForm, updatePinSchema } from "@/lib/schema/bvn-schema";
import { useResetPin, useUpdatePin } from "@/lib/services/security.service";
...
export const ResetPinModal = ({ open, handleClose }: ResetPinModalProps) => {
  const [success, setSuccess] = useState(false);
  const { sendOtp, cooldown, canResend } = useOtpFlow();
  const { mutate, isPending, error } = useResetPin();
